...
const Collections = () => {
  ...
  // Group products by metal type (show all groups that exist)
  ...
  // Use actual group keys so ALL products are shown (not just predefined metal types)
  const displayGroups = Object.keys(groupedProducts).sort((a, b) =>
