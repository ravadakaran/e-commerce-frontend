...
const Contact = () => {
  ...
  const handleSendRequest = (e) => {
    ...
    const body = encodeURIComponent(
      `Instagram: https://www.instagram.com/dangly_dreams/\n\n` +
      `Custom jewelry request details:\n\n` +
      `Name: ${formData.name || 'Anonymous'}\n` +
      `Email: ${formData.email || 'Not provided'}\n` +
      `Jewelry Type: ${formData.jewelryType}\n` +
      `Description:\n${formData.description}\n\n`
    );
    // Open mailto link (you can replace with your own email if desired)
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center text-gray-600">
                  ...
                  >
                    DM us on Instagram @dangly_dreams
                  </a>
                </div>
