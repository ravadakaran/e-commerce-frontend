import { Heart, Mail, Menu, Phone, Search, ShoppingBag, User, X } from 'lucide-react';
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const res = await fetch('/api/auth/signup', {
        ...
        body: JSON.stringify({ email, password, username, name: username, profilePic }),
      });
              ...
              <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="flex items-center justify-between py-6">
                  ...
                  <div className="absolute left-1/2 transform -translate-x-1/2">
                    <a href="/" className="text-3xl font-light tracking-[0.25em] text-gray-800 hover:text-amber-600 transition-colors">
                      DANGLY DREAMS
                    </a>
                  </div>
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-12 w-full max-w-md">
            ...
            <p className="text-gray-600 text-sm mb-8 text-center leading-relaxed">
              Join Dangly Dreams to explore our exclusive jewelry collections.
            </p>
