import { ArrowLeft, Check, Copy, Home, Printer } from "lucide-react";
...
const Success = () => {
  ...
  const printableHTML = `
    ...
    <body>
      <h2>Dangly Dreams</h2>
      <p style="text-align:center;font-size:10px">Mumbai, Maharashtra, India</p>
      <p style="text-align:center;font-size:10px">Instagram: @dangly_dreams</p>
      <hr/>
      ...
      ` : ""}
      <hr/>
      <p style="text-align:center;font-size:10px">Thank you for shopping with Dangly Dreams!</p>
    </body>
    </html>
  `;
